...
final class RetrieveAutocompleteItemsActionTest extends BaseFunctionalTestCase
{
    ...
    {
        $this->client->request(Request::METHOD_GET, '/admin/core/get-autocomplete-items?q=autocompletion&_per_page=10&_page=1&uniqid=s608eac968661e&_adminata_admin=IDCT%5CAdminata%5CDoctrineORM%5CTests%5CApp%5CAdmin%5CBookWithAuthorAutocompleteAdmin&field=author');
