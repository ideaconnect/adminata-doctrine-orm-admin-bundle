...
return static function (ContainerConfigurator $containerConfigurator): void {
    $containerConfigurator->services()
        ...
        ->set('adminata.admin.audit.orm.reader', AuditReader::class)
            ->public()
            ->tag('adminata.admin.audit_reader')
            ->args([
                service('simplethings_entityaudit.reader')->ignoreOnInvalid(),
            ])

        ->set('adminata.admin_doctrine_orm.block.audit', AuditBlockService::class)
            ->tag('adminata.block')
            ->args([
                service('twig'),
                service('simplethings_entityaudit.reader')->ignoreOnInvalid(),
